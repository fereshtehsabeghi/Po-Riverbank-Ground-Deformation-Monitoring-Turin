...
Spatial Triage & Data Ingestion (spatial_triage.py)
...
Statistical Hotspot Detection (hotspot_analysis.py)
...
Infrastructure Extraction (extract_infrastructure.py & check_distances.py)
...
Government Data Integration (process_ispra.py)
...
Web-GIS Optimization (fix_kepler_export.py)
...
$$Working Process in Terminal$$

(figures/a part of working process.jpg)
...
$$Basse di Stura Landfill Risk$$

(figures/ex discarica amiat basse di stura - landfill area.jpg)
...
(figures/green but hazardious.jpg)
...
(figures/overlap in the data i found and it is avaiable.jpg)
...
$$Unmapped Deformation Anomalies$$

(figures/the found points outside the hazardious data of italy - glitch.jpg)
...
$$Mirafiori Medium Danger Zone$$

(figures/mediumdangerzone-infrstructre danger-basse di mirafiori area.jpg)
!

$$Buildings in Danger - Corso Appio Claudio$$

(figures/infrastructure in danger(building-corso appio claudio).jpg)
!

$$Medium Risk with Buildings$$

(figures/medium-risk with buildings in it .jpg)
...
Data Sources: EGMS (Copernicus Copernicus Land Monitoring Service), ISPRA IdroGEO Open Data

Visualization: Kepler.gl (deck.gl rendering engine), QGIS

👤 Author

Feria (Fereshteh) Sabeghi Eskandar GIS Analyst & Visual Communication Designer Focusing on the intersection of data visualization, platform urbanism, and environmental risk assessment.
